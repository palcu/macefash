...
class Person(db.Model):
  """
  Model for each person that appears on the voting page
  """
...
class Vote(db.Model):
  """
  Model for votes. Helps keep track of them, in order to prevent spam.
  """
  __tablename__ = 'votes'
...
class Message(db.Model):
  """
  Model for user messages. In case someone wants their picture taken down.
  """
...
class UserSettings(db.Model):
  """
  IP based settings. Keeps track of preferred gender (for voting) and theme.
  """
